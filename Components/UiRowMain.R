  ...
  column(
    ...
    fluidRow(
      Component.MainValueBox(
        mainValue = sum(PCR_WITHIN$final, PCR_FLIGHT$final, PCR_SHIP$final, PCR_AIRPORT$final),
