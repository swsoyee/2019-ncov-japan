      ...
      value = tagList(
        ...
        tags$small(paste0("| ", mainValueSub), 
                   ...
                   bsTooltip(id = "discharged_info", 
                             title = paste0("確定済みの退院者数は", mainValueSub, "名、他にも", 
                             (mainValue - mainValueSub), 
                             "名の退院者は個々の陽性者との突合作業中。従って、入退院等の状況の合計とPCR検査陽性者数は一致しない。",
                             "<br><br>※令和２年４月２２日から厚労省公開している退院者数の基準が変わりました。"), 
                             placement = "top"),
                   style = "color:white;font-size:16px;margin-top:10px;margin-right:10px;opacity:0.8"
        )
      ),
