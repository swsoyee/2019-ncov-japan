  ...
  boxPlus(
    ...
    column(
      ...
      tags$p(paste0('当クラスターネットワークは、株式会社SIGNATEが提供したデータセットおよびリンク情報',
                    ...
                    'クラスターネットワークの正確さの保障は一切ないので、予めご了承ください。',
                    'あくまで参考用です。'
                    )),
      tags$p('データセット自身の問題で、ある患者は、多数の患者とリンクがあるとしても、クラスターの中心とはいえませんのでご了承ください'),
      tags$p('不定期更新。データセットに貢献したい有志はぜひ下記のリンク先でデータの追加や訂正をしてください。'),
      tags$a(href = 'https://signate.jp/competitions/260/discussions', 'SIGNATE - COVID-19 Chanllenge')
    )
    )
  )
