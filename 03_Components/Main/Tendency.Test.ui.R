  ...
  fluidRow(
    ...
    column(
      ...
      tagList(
        tags$br(),
        tags$b(i18n$t("注意事項")),
        tags$li(i18n$t("「「令和２年３月４日版」以後は、陽性となった者の濃厚接触者に対する検査も含めた検査実施人数を都道府県に照会し、回答を得たものを公表しています。なお、国内事例のＰＣＲ検査実施人数は、疑似症患者（感染が疑われる者）報告制度の枠組みの中で報告された数を計上しており、各自治体で行った全ての検査結果を反映しているものではありません（退院時の確認検査などは含まず）。")),
