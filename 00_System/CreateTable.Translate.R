...
tooltip <- list(
  "cn" = list("新規" = "新增", "累計" = "累计", "名" = "人", "情報待ち陽性者" = "等待消息的阳性患者", "入院者" = "住院", "退院者" = "出院", "退院" = "出院", "死亡者" = "死亡"),
  "en" = list("新規" = "New ", "累計" = "Total ", "名" = "", "情報待ち陽性者" = "Positive (more information needed) ", "入院者" = "Hospitalized ", "退院者" = "Discharged ", "退院" = "Discharged ", "死亡者" = "Death ")
)
